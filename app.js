$(document).ready(function() {
  ...
  // Run the random order function below on the data inside data.js. This will
  // display the cards in a random order on the page every time the page is
  // refreshed.
  shuffle(emojiItems);
  ...
  // initial variable we created that was for the container to hold the cards.
  ...
  // Display movies and show in a random order, the random order will refresh on
  ...
  // The code that runs the filter buttons at the top of the page. This
  // currently allows users to filter by 'type' (ie musical, movie or tv show).
